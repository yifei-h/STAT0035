r_files <- c("1. MC_sample.R", "2. simulation.R", "3. sample_size.R", "4. simulation_per_group.R", "5. simulation_varing_proportions.R", "6. simulation_whole.R")
